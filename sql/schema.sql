...
-- NOTE: Update these hashes after first run using the built-in "Reset Password" tool,
-- or run: php tools/make_hash.php  (see /tools/make_hash.php included in this package)
